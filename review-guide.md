...
- [ ] มี section "สำหรับ User ทั่วไป" ก่อน section "สำหรับ Developer"
- [ ] ส่วน dev เปิดด้วยประโยคแบบ "ส่วนนี้สำหรับ dev โดยเฉพาะ ถ้าไม่ใช่ dev จะข้ามได้"
- [ ] มี section **"Action Items สำหรับทุกคน"** (4 ข้อ + เพิ่มอีก 4 ข้อสำหรับ dev)
- [ ] มี section **"บทเรียนชีวิตจากบทความนี้"** (life lesson ระดับสากล)
...
- [ ] **ไม่มี prefix รหัส API จริง** ในตัวอย่างโค้ด (`sk_live_`, `sk_test_`, `AKIA`, `ghp_`, `sk-`, ฯลฯ)
- [ ] ใช้ `<placeholder>` syntax หรือ `STRIPE_SECRET_KEY_HERE` แทน
- [ ] เช็คทั้ง tutorial code และ example string ในบทความ
...
- [ ] ส่วน dev ใช้รูปแบบ **"❌ ผิด vs ✅ ถูก"** ในตัวอย่างโค้ด
- [ ] Code มี comment อธิบายว่าทำไมถึงผิด/ถูก
