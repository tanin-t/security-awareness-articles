...
ทั้งทีมตื่นตระหนก ระบบต้องถูกปิดกั้นการเข้าถึง (lock down) ลูกค้าบางส่วนได้รับผลกระทบ ใช้เวลาสองวันเต็มในการกู้คืนทุกอย่าง พอมาทำการวิเคราะห์สาเหตุหลังเหตุการณ์ (post-mortem)[^2] แล้วก็พบว่า สาเหตุคือเรื่องง่ายๆ ที่ไม่มีใครคิดว่าจะเป็นปัญหา — มีคนในทีมใช้รหัสผ่านเดียวกันกับเว็บอื่นที่เคยถูกเจาะข้อมูล (data breach)[^3] ไปก่อนหน้านี้ แล้วผู้โจมตี (attacker) เอารหัสผ่านที่หลุดมาลองเข้าระบบต่างๆ จนเข้าได้สำเร็จ

ไม่มีมัลแวร์ (malware)[^4] ซับซ้อน ไม่มีช่องโหว่ที่เพิ่งค้นพบและยังไม่มีทางแก้ (zero-day exploit)[^5] ไม่มีแฮกเกอร์ระดับรัฐ (nation-state hacker)[^6] แค่ **ความประมาทเล็กๆ เรื่องเดียว**
